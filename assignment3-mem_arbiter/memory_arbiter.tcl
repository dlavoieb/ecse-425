...
proc AddWaves {} {
  ...
  add wave -position end  -radix hex sim:/memory_arbiter/main_memory/Block0/Memory(0)
  add wave -position end  -radix hex sim:/memory_arbiter/main_memory/Block1/Memory(0)
  add wave -position end  -radix hex sim:/memory_arbiter/main_memory/Block2/Memory(0)
